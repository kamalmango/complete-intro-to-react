	...
	var Header = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.props.showSearch) {
	      utilSpace = React.createElement('input', { type: 'text', className: 'search-input',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var axios = __webpack_require__(251); // ajax library that uses promises 
	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      // does not get called in node and perfect place to do ajax calls
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          rating,
	          React.createElement('img', { className: 'video-poster', src: '/public/image/posters/' + poster }),
	          React.createElement(
	            'p',
	            { className: 'video-descriptoin' },
	            description
	          )
	        ),
	        React.createElement(
